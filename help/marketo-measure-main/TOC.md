...
+ [Marketo Measure概觀](/help/marketo-measure-main/marketo-measure-overview.md)
+ Marketo Measure安裝 {#install}
   + [Marketo Measure安裝](/help/marketo-measure-main/installing/install-production.md)
   + [修改許可權集](/help/marketo-measure-main/installing/modify-permission-sets-production.md)
   + [共用和隱藏報告和儀表板](/help/marketo-measure-main/installing/sharing-reports-production.md)
   + [建立 [!DNL Marketo Measure] 帳戶](/help/marketo-measure-main/installing/creating-marketo-measure-account-production.md)
+ 入門 {#onboarding}
   + 最佳做法 {#best-practices}
      + [檢閱報表設定(Pt.1)](/help/marketo-measure-main/onboarding/fundamentals/review-reporting-setting-pt1.md)
      + [檢閱管道和整合設定(Pt.2)](/help/marketo-measure-main/onboarding/fundamentals/channel-integration-settings.md)
      + [CRM設定(Pt.3)](/help/marketo-measure-main/onboarding/fundamentals/crm-settings.md)
      + [銷售機會、聯絡人和機會的設定](/help/marketo-measure-main/onboarding/fundamentals/leads-contacts-opps-settings.md)
      + [線上頻道設定](/help/marketo-measure-main/onboarding/fundamentals/online-channel-setup.md)
      + [Ads連線總覽](/help/marketo-measure-main/onboarding/fundamentals/ads-connection-overview.md)
      + [SFDC安裝概述](/help/marketo-measure-main/onboarding/fundamentals/sfdc-installation-overview.md)
      + [離線管道設定](/help/marketo-measure-main/onboarding/fundamentals/offline-channel-setup.md)
      + [與Marketo Engage的連線](/help/marketo-measure-main/onboarding/fundamentals/connection-with-marketo-engage.md)
   ...
   + [!DNL Marketo Measure] 101 {#marketo-measure-101}
      ...
      + [什麼是 [!DNL Marketo Measure]](/help/marketo-measure-main/onboarding/marketo-measure-101/what-is-marketo-measure.md)
      + [Marketo Measure資料](/help/marketo-measure-main/onboarding/marketo-measure-101/marketo-measure-data.md)
   ...
   + [!DNL Marketo Measure]與Salesforce{#marketo-measure-salesforce}
      + [依ID的銷售機會報表](/help/marketo-measure-main/onboarding/marketo-measure-salesforce/leads-by-id-report.md)
      + [建立管道和子管道](/help/marketo-measure-main/onboarding/marketo-measure-salesforce/creating-channels-subchannels.md)
      + [使用CSV檔案設定管道規則](/help/marketo-measure-main/onboarding/marketo-measure-salesforce/channel-rules-csv.md)
      + [行銷活動物件欄位](/help/marketo-measure-main/onboarding/marketo-measure-salesforce/campaign-object-fields.md)
      + [對應離線頻道](/help/marketo-measure-main/onboarding/marketo-measure-salesforce/mapping-offline-channels.md)
      + [同步離線行銷活動](/help/marketo-measure-main/onboarding/marketo-measure-salesforce/syncing-offline-campaigns.md)
   + 基礎知識{#fundamentals}
...
+ [!DNL Marketo Measure]個探索 {#marketo-measure-discover}
   ...
   + [決定正在執行的頻道(Pt.1)](/help/marketo-measure-main/marketo-measure-discover/top-of-funnel-reporting.md)
   + [決定正在執行的頻道(Pt.2)](/help/marketo-measure-main/marketo-measure-discover/determine-which-channel-is-performing.md)
   + [探索Funnel報表(Pt.3)](/help/marketo-measure-main/marketo-measure-discover/build-a-full-funnel-report-pt3.md)
+ 定義 {#definitions}
   + 接觸點{#touchpoints}
      + [什麼是接觸點？](/help/marketo-measure-main/definitions/touchpoints/what-is-a-touchpoint.md)
      + [里程碑接觸點](/help/marketo-measure-main/definitions/touchpoints/milestone-touchpoints.md)
      + [接觸點元件](/help/marketo-measure-main/definitions/touchpoints/touchpoint-components.md)
      + [線上和離線接觸點](/help/marketo-measure-main/definitions/touchpoints/online-offline-touchpoints.md)
   + 歸因 {#attribution}
      + [什麼是歸因](/help/marketo-measure-main/definitions/attribution/what-is-attribution.md)
      + [歸因模型](/help/marketo-measure-main/definitions/attribution/attribution-models.md)
      + [首次接觸模型](/help/marketo-measure-main/definitions/attribution/first-touch-model.md)
      + [潛在客戶建立模型](/help/marketo-measure-main/definitions/attribution/lead-creation-model.md)
   ...
   + crm物件 {#crm-objects}
      ...
      + [機會物件](/help/marketo-measure-main/definitions/crm-objects/opportunity-object.md)
      + [BT物件](/help/marketo-measure-main/definitions/crm-objects/bt-object.md)
   ...
   + UTM引數 {#utm-parameters}
      ...
      + [UTM引數自動標籤工具](/help/marketo-measure-main/definitions/utm-parameters/utm-parameter-auto-tagging-tools.md)
      + [UTM標籤](/help/marketo-measure-main/definitions/utm-parameters/utm-tagging.md)
   + 帳戶型行銷 {#account-based-marketing}
      + [[!UICONTROL Account Based Marketing] 概覽](/help/marketo-measure-main/definitions/account-based-marketing/abm-overview.md)
      ...
      + [[!UICONTROL Accounts with Leads and Contacts]報告](/help/marketo-measure-main/definitions/account-based-marketing/accounts-with-leads-and-contacts.md)
      + [[!UICONTROL Touchpoints per Account]報告](/help/marketo-measure-main/definitions/account-based-marketing/touchpoints-per-account-report.md)
   + 回馬朗舞台 {#boomerang-stage}
      + [迴旋鏢階段簡介](/help/marketo-measure-main/definitions/boomerang-stage/introduction-to-boomerang-stages.md)
      + [設定回力行階段](/help/marketo-measure-main/definitions/boomerang-stage/setting-up-boomerang-stages.md)
+ Marketo Measure Ultimate {#marketo-measure-ultimate}
   + [Marketo Measure Ultimate概觀](/help/marketo-measure-main/marketo-measure-ultimate/overview.md)
   + [Attribution AI概述](/help/marketo-measure-main/marketo-measure-ultimate/attribution-ai-overview.md)
+ 宣講者談話 {#evangelist}
   + [行銷屬性和量度](/help/marketo-measure-main/evangelist-talks/attribution-and-metrics.md)
